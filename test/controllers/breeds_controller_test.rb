...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { description: @breed.description, name: @breed.name } }
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { description: @breed.description, name: @breed.name } }
